...
\begin{center}
    ...
    \hline
    \multirow{3}{*}{Source} & Text string (TXT) & Chenye \\ 
    & Image (PNG) & Chenye \\ 
    & Audio (WAV) & Chenye \\ 
    \hline
    \multirow{2}{*}{Encoder} & $(7,4)$ Hamming & Chenye \\ 
    & CRC & name \\ 
    \hline
    \multirow{1}{*}{Channel} & BSC & Chenye \\ 
    \hline
    \multirow{2}{*}{Error Corrector} & $(7,4)$ Hamming with Syndrome Lookup Table & Chenye \\ 
    & CRC & name \\ 
    \hline
    \multirow{2}{*}{Decoder} & $(7,4)$ Hamming & Chenye \\ 
    & CRC & name \\ 
    \hline
    \multirow{3}{*}{Destination} & Text string (TXT) & Chenye \\ 
    & Image (PNG) & Chenye \\ 
    & Audio (WAV) & Chenye \\ 
    \hline
    \end{tabulary}
